...
def to_complex_denoiser(denoiser, mode="separated"):
    r"""
    ...
    class c_complex_denoiser(torch.nn.Module):
        ...
        def forward(self, x, sigma=None):
            if self.mode == "separated":
                ...
                x1 = denoised_batch[: x_real.shape[0], ...]
                x2 = denoised_batch[x_real.shape[0]:, ...]
    ...
    return c_complex_denoiser(denoiser, mode)
